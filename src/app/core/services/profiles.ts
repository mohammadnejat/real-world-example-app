...
import { ResponseProfileModel } from '../models/profile.model';
...
export class Profiles {
  ...
  getUserProfile(username: string): Observable<ResponseProfileModel> {
    return this.#http.get<ResponseProfileModel>(`${this.#profileUrl}/${username}`);
  }
